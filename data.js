...
export const BOARD = [
  { id:"go", name:"Piornedo", type:"go", x:87, y:87 },
  { id:"rua-o-pozo", name:"Rúa O Pozo", type:"property", propertyId:"rua-o-pozo", x:79, y:87 },
  { id:"caixa-1", name:"Caixa Veciñal", type:"caixa", x:72, y:87 },
  { id:"rua-calvario", name:"Rúa Calvario", type:"property", propertyId:"rua-calvario", x:65, y:87 },
  { id:"servizos-1", name:"Servizos", type:"service", x:59, y:87 },
  { id:"o-chiringuito", name:"O Chiringuito", type:"station", stationId:"o-chiringuito", x:52, y:87 },
  { id:"rua-nogueira", name:"Rúa Nogueira", type:"property", propertyId:"rua-nogueira", x:45, y:87 },
  { id:"cartina-1", name:"Cartiña", type:"event", x:39, y:87 },
  { id:"rua-da-canella", name:"Rúa Da Canella", type:"property", propertyId:"rua-da-canella", x:32, y:87 },
  { id:"rua-o-rial", name:"Rúa O Rial", type:"property", propertyId:"rua-o-rial", x:25, y:87 },
  { id:"campo-futbol", name:"Campo de Fútbol / Granxa Eloi", type:"corner", x:14, y:87 },

  { id:"rua-calleteiro", name:"Rúa Calleteiro", type:"property", propertyId:"rua-calleteiro", x:15, y:76 },
  { id:"cartina-2", name:"Cartiña", type:"event", x:15, y:67 },
  { id:"rua-cachon", name:"Rúa Cachón", type:"property", propertyId:"rua-cachon", x:15, y:59 },
  { id:"rua-fendonces", name:"Rúa Fendonces", type:"property", propertyId:"rua-fendonces", x:15, y:51 },
  { id:"a-gudina-porta-de-galicia", name:"A Gudiña - Porta de Galicia", type:"station", stationId:"a-gudina-porta-de-galicia", x:15, y:43 },
  { id:"karting-chaves", name:"Karting Chaves", type:"property", propertyId:"karting-chaves", x:15, y:35 },
  { id:"servizos-2", name:"Servizos", type:"service", x:15, y:27 },
  { id:"merendoiro", name:"Merendoiro", type:"property", propertyId:"merendoiro", x:15, y:19 },
  { id:"embalse-de-campos", name:"Embalse de Campos", type:"property", propertyId:"embalse-de-campos", x:15, y:11 },
  { id:"parking", name:"Parking / descanso", type:"corner", x:19, y:6 },

  { id:"resort-da-tia-otilia", name:"Resort Da Tía Otilia", type:"property", propertyId:"resort-da-tia-otilia", x:31, y:8 },
  { id:"cartina-3", name:"Cartiña", type:"event", x:38, y:8 },
  { id:"portozon", name:"Portozón", type:"property", propertyId:"portozon", x:45, y:8 },
  { id:"rio-do-molino", name:"Río Do Molino", type:"property", propertyId:"rio-do-molino", x:52, y:8 },
  { id:"estacion-buses-verin", name:"Estación de Buses - Verín", type:"station", stationId:"estacion-buses-verin", x:58, y:8 },
  { id:"foxo-do-lobo", name:"Foxo Do Lobo", type:"property", propertyId:"foxo-do-lobo", x:64, y:8 },
  { id:"forno", name:"Forno", type:"property", propertyId:"forno", x:70, y:8 },
  { id:"servizos-3", name:"Servizos", type:"service", x:76, y:8 },
  { id:"igrexa", name:"Igrexa", type:"property", propertyId:"igrexa", x:82, y:8 },
  { id:"a-fonte", name:"A Fonte", type:"corner", x:91, y:10 },

  { id:"pedralonga", name:"Pedralonga", type:"property", propertyId:"pedralonga", x:86, y:19 },
  { id:"cachon-da-cenza", name:"Cachón Da Cenza", type:"property", propertyId:"cachon-da-cenza", x:86, y:27 },
  { id:"caixa-2", name:"Caixa Veciñal", type:"caixa", x:86, y:35 },
  { id:"reitoral-da-chaira", name:"Reitoral Da Chaira", type:"property", propertyId:"reitoral-da-chaira", x:86, y:43 },
  { id:"estacion-campobecerros", name:"Estación de Campobecerros", type:"station", stationId:"estacion-campobecerros", x:86, y:51 },
  { id:"cartina-4", name:"Cartiña", type:"event", x:86, y:59 },
  { id:"tanatorio", name:"Tanatorio", type:"property", propertyId:"tanatorio", x:86, y:67 },
  { id:"servizos-4", name:"Servizos", type:"service", x:86, y:75 },
  { id:"praza", name:"Praza", type:"property", propertyId:"praza", x:86, y:82 }
];
